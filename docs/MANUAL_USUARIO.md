...
- **Términos y condiciones** (en Cotizador): vienen cargados los de los **dos** documentos que se mandan al cliente, que son distintos entre sí. Hay tres grupos: **General** (lo que sale siempre), **Categoría A** y **Categoría B**; cada cotización muestra el general más el de la gama de sus telas. Ojo con las diferencias reales: la A ofrece **6 cuotas** y la B **12**; la A cobra la primera visita ($15.000) y la B no; la A garantiza la instalación 3 años y la B 2. Si tus términos ya hablan de la tarjeta de crédito, la app deja de agregar su propia frase para no repetirla.
