...
const RESUMEN_MOLDE: Record<string, string> = {
  ...
  ROL_MANUAL_CENEFA_OVALADA_45mm: 'Roller con cenefa ovalada de 45 mm (tubo E39), kit ovalada por color.',
  ...
  DUO_MANUAL_45mm: 'Dúo día/noche de 45 mm (tubo E39), kit ovalada por color.',
