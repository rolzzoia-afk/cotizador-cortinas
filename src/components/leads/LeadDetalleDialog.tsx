...
// Consejo contextual: muestra las objeciones útiles según el estado del lead.
// Lee del manual de coaching (editable por admin) y filtra por categoría.
function CoachingContextual({ estado }: { estado: LeadEstado }) {
      ...
      <DialogContent className="max-h-[90vh] max-w-3xl overflow-y-auto border-border bg-card text-foreground">
        ...
        <div className="grid gap-5 md:grid-cols-[1.2fr_1fr]">
          ...
          <div className="space-y-4">
            ...
            {/* Consejo contextual de coaching según el estado */}
